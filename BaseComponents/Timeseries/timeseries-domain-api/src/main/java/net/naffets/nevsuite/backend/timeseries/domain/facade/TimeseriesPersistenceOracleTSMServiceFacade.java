 ...
 */
@Remote
@Facade(module = "timeseries-domain-ejb-0.11", implementation = "TimeseriesPersistenceOracleTSMServiceImpl")
public interface TimeseriesPersistenceOracleTSMServiceFacade extends ServiceFacade, PersistenceStrategy {
}
