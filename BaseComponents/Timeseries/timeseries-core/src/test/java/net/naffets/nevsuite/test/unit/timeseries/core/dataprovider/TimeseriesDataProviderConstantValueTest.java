 ...
 */
public class TimeseriesDataProviderConstantValueTest {

    private final Logger logger = LogManager.getLogger(TimeseriesDataProviderConstantValue.class.getName());
    ...
    public void testLoadValuesDay() {
        ...
        TimeseriesDataProvider<ValueStatusPair<Long, byte[]>> dataProvider = new TimeseriesDataProviderConstantValue<>(
                new ValueStatusPairPlugin<>(new LongPlugin(), new byte[8]),
                new ValueStatusPair<>(1L, new byte[8]),
