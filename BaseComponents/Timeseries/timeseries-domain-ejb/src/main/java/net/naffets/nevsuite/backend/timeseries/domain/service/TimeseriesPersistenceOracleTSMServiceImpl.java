...
import net.naffets.nevsuite.backend.timeseries.domain.facade.TimeseriesPersistenceOracleTSMServiceFacade;
 ...
 */
@Stateless
@Remote(TimeseriesPersistenceOracleTSMServiceFacade.class)
@Local(TimeseriesPersistenceOracleTSMService.class)
public class TimeseriesPersistenceOracleTSMServiceImpl implements TimeseriesPersistenceOracleTSMService {

    private static final Logger logger = LogManager.getLogger(TimeseriesPersistenceOracleTSMService.class.getName());
    private PersistenceStrategy persistenceStrategy;

    public TimeseriesPersistenceOracleTSMServiceImpl() {
        try {
            Properties properties = new Properties();
            properties.load(this.getClass().getClassLoader().getResourceAsStream("timeseries-database-hub.properties"));
            this.persistenceStrategy = PersistenceStrategyFactory.getInstance("oracledb", properties);
        } catch (Exception e) {
